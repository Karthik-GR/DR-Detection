...
if uploaded_file is None:
    ...
    try:
        ...
        confidence_1 = predictions[0][predicted_class_index]
        ...
        confidence_2 = predictions_2[0][predicted_class_index_2]
        ...
        st.write(f'<div style="background-color:{bg_color_1}; color:black; padding: 10px; border-radius: 5px;">'
                 f'<span style="color:black;">Predicted Category by EfficientNetB0: {predicted_class}</span><br>'
                 f'Confidence: {confidence_1:.2f}'
        ...
        st.write(f'<div style="background-color:{bg_color_2}; color:black; padding: 10px; border-radius: 5px;">'
                 f'<span style="color:black;">Predicted Category by DenseNet121: {predicted_class_2}</span><br>'
                 f'Confidence: {confidence_2:.2f}'
                 '</div>', unsafe_allow_html=True)
        
        # Disclaimer footer
        st.markdown("---")
        st.markdown("### Disclaimer")
        st.markdown("This prediction is for educational and informational purposes only. It is not a substitute for professional medical advice, diagnosis, or treatment. Please consult an ophthalmologist or healthcare professional for accurate diagnosis and appropriate treatment.")
